...
import loginImg from "../assets/subAdmin/login.svg"
...
const SubAdminLogin = () => {
  ...
  return (
    <>
      {isAccountTypesLoading ? ( // Render the page loader if isLoading is true
        <LoginSkeleton />
      ) : (
        <div className="subadminlogin-section min-h-screen bg-gray-100 py-8 lg:px-30 3xl:px-52 flex flex-col md:flex-row justify-around mx-auto items-center">
          <div className="max-w-md hidden xl:flex w-full items-center justify-center h-auto py-20 px-5 bg-blue-gray-500 rounded-xl">
          <img className="w-full h-auto" src={loginImg} alt="" />
          </div>
          <div className="max-w-md">
            <div className="bg-white mx-auto rounded-lg shadow-lg p-6 w-96">
              <div className="mb-8">
              ...
              <form onSubmit={handleSubmit} method="post">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-2 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white font-medium rounded-lg"
                >
              ...
              <div className="text-center my-6">
                <Link
                  to={"/"}
                  className="w-full px-6 py-2 bg-gradient-to-r hover:from-green-400 hover:to-blue-500 from-pink-500 to-yellow-500 text-white font-medium rounded-lg my-6"
                >
                  Go to home
                </Link>
              </div>
