...
const Sidebar = ({ context }) => {
  ...
  const [user] = context;
  const { data: auth } = useQuery("getAdminAuth", getAdminAuth);
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a className="flex ml-2 md:mr-24">
                <img src={Logo} className="h-8 mr-3" alt="BDLearningPoint Logo" />
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="nav-menu-section h-full px-3 py-6 rounded-r-[15%] overflow-y-auto">
