...
const Login = () => {
  ...
  return (
    <div className="lg:w-5/12 w-full pt-28 pb-10 lg:mx-auto">

      <div className="md:p-10 p-5 mx-5 rounded-lg" style={{boxShadow: '0 0 50px #ccc'}}>
        <h2 className="lg:text-4xl text-3xl font-semibold">Welcome back!</h2>
        <p className="text-gray-500 font-semibold py-3">
          Login to access your seller profile settings, do sales training,
          and sell services.
        </p>
