...
const ForgetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formValid) {
      try{
        const response = await axios.post('https://bdlearningpoint.com/backend/public/api/auth/forget', formData);
  ...
  const handlePSubmit = async (e) => {
    ...
    if (formValid) {
      ...
      try{
        const response = await axios.post('https://bdlearningpoint.com/backend/public/api/auth/verify-code', {
