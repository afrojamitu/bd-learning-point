...
const HeroSection = () => {
  ...
  return (
    <section
      className={`bg-black py-16 md:py-24 lg:py-40 border-b-gray-200 border-b-4 relative ${
        ...
        <div className="heroContent ">
          <h1>
            <span className={`text-4xl md:text-6xl lg:text-7xl font-bold mb-4 uppercase text-black bg-gradient-to-r to-blue-500 from-blue-300 bg-clip-text text-transparent animate-gradient`}>
              <span>BDLearningPoint </span>
              <span>E-Learning PLATFORM</span>
            </span>
          </h1>
          <p className="text-lg md:text-xl lg:text-xl mb-10 mt-8 text-white">
          ...
          {user && token ? (
            ...
            <div className="heroButton block w-full lg:flex space-y-4 md:space-y-0 md:space-x-4">
              <Link
                to="/login"
