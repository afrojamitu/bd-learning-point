  ...
  return (
    <div className="px-4 py-16 lg:py-40 teamMemberSection">
      <div className="max-w-md lg:max-w-3xl mx-auto text-center">
        ...
        <p className='text-md lg:text-xl text-white mt-3 px-2 lg:px-10 font-semibold uppercase'>BDLearningPoint E-LEARNING PLATFORM GIVES YOU A CORPORATE ENVIRONMENT AND HELPFULL DIGITAL MARKETING COMMUNITY</p>
