  ...
  return (
    <>
      {isLoading || isLoggedIn ? ( // Render the page loader if isLoading is true
        ...
        <div className="adminlogin-section min-h-screen bg-gray-100 py-8 flex justify-center items-center">
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6 w-96">
              ...
              <form onSubmit={handleSubmit} method="post">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-2 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white font-medium rounded-lg flex items-center justify-center"
                >
                  {" "}
                  {submitLoading ? (
