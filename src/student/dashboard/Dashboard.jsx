          ...
          {isLoading ? (
            ...
            <>
              <div className="max-w-screen-xl mx-auto text-center">
                ...
                <div className="mb-5 flex items-center flex-col lg:flex-row justify-center bg-gradient-to-r from-[#070c44] to-[#422e9d] p-5 shadow-md sm:rounded-lg">
                        ...
                        <>
                          ...
                          <div className="flex justify-between items-center border-white border-[1.5px] rounded p-4 my-2">
                            ...
                            <p>
                              {" "}
                              <a
                                href={`https://api.whatsapp.com/?phone=+${data?.data?.data?.instructorsData?.phone_number}`}
                                className="bg-gradient-to-r from-[#070c44] to-[#422e9d] hover:to-[#070c44] hover:from-[#422e9d]  text-white p-2 rounded-lg px-6"
                              >
                                Whatsapp
                              </a>
                            </p>
                        ...
                        <>
                          ...
                          <div className="flex justify-between items-center border-white border-[1.5px] rounded p-4 my-2">
                            ...
                            <p>
                              {" "}
                              <a
                                href={`https://api.whatsapp.com/?phone=+${data?.data?.data?.leader_u?.phone_number}`}
              ...
              <div className="max-w-screen-xl px-4 mx-auto text-center ">
                <div className="grid lg:grid-cols-3 grid-cols-1 gap-10">
                    ...
                    <div className="py-6 rounded-lg w-full px-6">
                      {getMeetings()?.length != 0 &&
                        getMeetings()?.map((gmeet, key) => (
                          <div
                            key={key}
                            className="w-full text-left p-4 flex justify-between items-center bg-gradient-to-r from-[#070c44] to-[#422e9d] text-white hover:shadow-xl cursor-pointer my-2 rounded"
                          >
                            <div>
                  ...
                  <div className="">
                    <div className="flex justify-between items-center bg-gradient-to-r from-[#070c44] to-[#422e9d] my-5 py-2 px-4 rounded-md shadow-lg">
                    ...
                    <div className="py-6 border bg-gradient-to-r from-[#070c44] to-[#422e9d] border-gray-400 rounded-lg w-full px-6 break-all shadow-lg">
                      ...
                      <div className="w-full text-left p-4 flex justify-between items-center bg-[#070c44] shadow-xl rounded-b-md cursor-pointer">
                        <div>
                          ...
                          <div className="flex justify-between items-center border border-1 p-4 my-2">
                            ...
                            <p>
                              ...
                              <a
                                target="_blank"
                                rel="noreferrer"
                                href={`https://api.whatsapp.com/?phone=+${data?.data?.data?.app_contact_number?.option_value}`}
                                className="bg-gradient-to-r from-[#070c44] to-[#422e9d] text-white p-2 rounded-lg px-6"
                              >
                                Whatsapp
                              </a>
                            </p>
