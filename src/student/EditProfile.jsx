  ...
  if (!isLoading)
    content = (
      <form className="p-5" onSubmit={handleSubmit}>
        <div className="relative z-0 w-full mb-12 group bg-green-500 px-8 py-12">
          <label
          ...
          <ImageUpload
            ...
            className="w-[120px] h-[100px] border border-2 border-white"
          />
          <div
        ...
        {/* <div className="relative z-0 w-full mb-6 group">
          <input
            ...
            name="floating_email"
            id="floating_email"
            className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-blue-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 "
            placeholder=""
            defaultValue={email}
    ...
    <>
      ...
      <div className="container mx-auto my-5 p-5">
        <div className="my-12">
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg bg-gray-200 dark:bg-gray-900 p-6">
