...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    //         'https://bdlearningpoint.com/backend/public/api/student/profile',
    //         {
    //             headers: {
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="container mx-auto my-5 p-0 md:p-5">
                ...
                <ul className="bg-blue-500 text-white hover:text-white hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                  <li className="flex items-center py-3">
                    ...
                    <span className="ml-auto">
                      <span
                        className={`${user?.data?.data?.user?.student.status == 1
                          ? "bg-green-500"
                          : "bg-red-500"
              ...
              <div className="p-5 shadow-sm rounded-lg">
                <div className="flex justify-between items-center py-2 px-5 bg-blue-600 font-semibold shadow-md my-4 mb-12">
                  ...
                  <div className="w-full md:w-2/4">
                    <Link to="/student/edit_profile" className="flex justify-center gap-2 bg-blue-900 py-2 px-4 text-white rounded-md shadow-md">
                      <svg
                        className="w-6 h-6"
                        aria-hidden="true"
